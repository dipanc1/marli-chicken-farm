...
function Product({ productData }) {
    ...
    const [price, setPrice] = useState(productData.prices[0]);
    ...
    const handleSize = (sizeIndex) => {
        const difference = productData.prices[sizeIndex] - productData.prices[size];
        setSize(sizeIndex);
    ...
    const handleClick = () => {
        dispatch(addProduct({ ...productData, extras, price, quantity }))
    };
        ...
        <div className={styles.container}>
            ...
            <div className={styles.right}>
                ...
                <div className={styles.ingredients}>
                    {productData.extraOptions.map((option) => (
